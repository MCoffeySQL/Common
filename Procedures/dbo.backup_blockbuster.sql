...
DROP PROCEDURE IF EXISTS dbo.backup_blockbuster;
GO

CREATE OR ALTER PROCEDURE dbo.backup_blockbuster
  @backupType NVARCHAR(24)
AS
BEGIN
  --Usage Example:
  --  EXEC dbo.backup_blockbuster 'Full'
  --  EXEC dbo.backup_blockbuster 'Differential'

  DECLARE 
    @databaseName NVARCHAR(128) = 'blockbuster',
