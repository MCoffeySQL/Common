...
DROP PROCEDURE IF EXISTS dbo.backup_medical;
GO

CREATE OR ALTER PROCEDURE dbo.backup_medical
  @backupType NVARCHAR(24)
AS
BEGIN
  --Usage Example:
  --  EXEC dbo.backup_medical 'Full'
  --  EXEC dbo.backup_medical 'Differential'

  DECLARE 
    @databaseName NVARCHAR(128) = 'medical',
