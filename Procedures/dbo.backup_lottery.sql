...
DROP PROCEDURE IF EXISTS dbo.backup_lottery;
GO

CREATE OR ALTER PROCEDURE dbo.backup_lottery
  @backupType NVARCHAR(24)
AS
BEGIN
  --Usage Example:
  --  EXEC dbo.backup_lottery 'Full'
  --  EXEC dbo.backup_lottery 'Differential'

  DECLARE 
    @databaseName NVARCHAR(128) = 'lottery',
